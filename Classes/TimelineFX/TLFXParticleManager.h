...
namespace TLFX
{
    ...
    public:
         ...
         */
		virtual std::set<Effect*>::iterator RemoveEffect(Effect* effect);
    ...
    protected:
        ...
        virtual void DrawSprite(AnimImage* sprite, float px, float py, float frame, float fw, float fh, float x, float y, float rotation,
